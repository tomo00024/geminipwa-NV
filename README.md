...
# titan823による派生版 GeminiPWA(ti) の変更点・仕様（2025年6月時点）
...
-  本コードは本家（フォーク元）の後継となることを意図するものでは断じてございません。本家コードに対し異を唱える意図も一切ございません。本フォークはプルリクエストを行いません。私的使用を目的とするバリュエーションのひとつと捉えてください。
