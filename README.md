...
*  （⚠️の数は重要度を指します）
*   ⚠️⚠️⚠️不安定感を解消するため、安定版であった7月26日版から実装作業をやり直しする予定です。その際、webhook機能は一旦削除させていただきます。2025/08/12
...
## ■ 更新履歴
### 【2025/08/11】
-  バグフィックス（新規でセッションを始め、はじめてのメッセージを送ると、AIからの応答が思考プロセスの内容だけで終わってしまい、メッセージ本文が出力されない、もしくは(応答が空です)と出力されてしまう問題
